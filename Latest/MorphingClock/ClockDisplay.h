...
class ClockDisplay{
  public:
    ...
    void show_weather(float current_temp, float min_temp, float max_temp, float feels_like_temp, const char *conditions);
  ...
  private:
    ...
    void draw_weather_conditions(const char *conditions);
